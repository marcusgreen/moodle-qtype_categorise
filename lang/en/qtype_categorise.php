...
/**
 * Strings for component 'qtype_categorise', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginnameediting'] = 'Editing a categorise question';
$string['group'] = 'Group';


$string['pluginnamesummary'] = 'A categorise question type which allows the embedding of the response fields for various available
